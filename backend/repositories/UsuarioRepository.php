<?php
    ...
    class UsuarioRepository{
        ...
        public function update(Usuario $usuario){
            ...
            $sql = "UPDATE usuarios SET nombre = :nombre, apaterno = :apaterno, amaterno = :amaterno, direccion = :direccion, telefono = :telefono, ciudad = :ciudad, estado = :estado, usuario = :usuario, password = :password, rol = :rol WHERE id = :id";
